"""
Django settings for sokirko_info project.
...
DEBUG = bool(os.environ.get('SOKIRKO_INFO_DEBUG', "True"))
...
ROOT_URLCONF = 'sokirko_info.urls'
...
WSGI_APPLICATION = 'sokirko_info.wsgi.application'
